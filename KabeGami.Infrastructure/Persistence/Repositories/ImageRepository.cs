        ...
        : IImageRepository
{
    ...
    public async Task<ErrorOr<List<Image>>> GetImages(List<ImageId> imageIds, CancellationToken cancellationToken)
    {
        List<Error> errors = [];
    ...
    public async Task<ErrorOr<Unit>> IsImageIdsExist(List<ImageId> imageIds, CancellationToken cancellationToken)
    {
        List<Error> errors = [];
    ...
    public async Task<ErrorOr<Image>> RemoveImageAsync(ImageId imageId, CancellationToken cancellationToken)
    {
